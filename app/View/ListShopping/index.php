...
<body>
    ...
    <main>
        <div class="wrapper-container">
            ...
            <h4 class="heading">Kits turbos</h4>
            <section class="list-products">
                <!-- <card-product>
                    <img src="../../assets/img-products/car-opala-principal.jpg" alt="" slot="img">
                    <img src="../../assets/img-products/car-opala-1.jpg" alt="" slot="galeria-img">
                    <h5 slot="title-product">Kit Opala SS - 6 cilindros</h5>
                    <p slot="title-descrition">Opala SS 1979 Original 2.5...</p>
                    <small slot="value-default">500,00</small>
                    <strong slot="price">345,00</strong>
                </card-product> -->
                ...
                <div class="card-product">
                    <div class="picture">
                        ...
                        <img src="../assets/img-products/car-ferrari-principal.jpg" alt="">
                        <div class="galeria hover-only">
                            <span>
                                <img src="../assets/img-products/car-ferrari-principal.jpg" alt="">
                            </span>
                    ...
                    <div class="body">
                        ...
                        <div class="value hover-only">
                            <span class="flex row  align-center gap-3">
                                <i data-feather="dollar-sign"></i>
                                <span class="flex column gap-1 align-start values">
                                    <small>7.200,00</small>
                                    <strong class="price">4.499,99</strong>
                                </span>
                            </span>
                            <div class="actions-card">
                                <button class="px-3 list-is-visible"><i data-feather="heart"></i></button>
